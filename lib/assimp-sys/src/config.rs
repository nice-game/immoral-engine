...
bitflags! {
	...
	pub struct AiUVTransformFlags : c_uint {
		...
		const AI_UVTRAFO_ALL = AiUVTransformFlags::AI_UVTRAFO_SCALING.bits
							 | AiUVTransformFlags::AI_UVTRAFO_ROTATION.bits
							 | AiUVTransformFlags::AI_UVTRAFO_TRANSLATION.bits;
	}
}
